...
v1.get('/endpoints', asyncHandler(overviewController.getEndpoints));
...
// Characters
v1.get('/characters', asyncHandler(characterController.findAll));
v1.get('/characters/random', asyncHandler(characterController.findRandom));
v1.get('/characters/:uuid', asyncHandler(characterController.findBy));
...
// Actors
v1.get('/actors', asyncHandler(actorController.findAll));
v1.get('/actors/random', asyncHandler(actorController.findRandom));
v1.get('/actors/:uuid', asyncHandler(actorController.findBy));
v1.get('/actors/:uuid/socials', asyncHandler(actorController.findAllSocials));
v1.get('/actors/:uuid/socials/random', asyncHandler(actorController.findRandomSocial));
v1.get('/actors/:uuid/socials/:name', asyncHandler(actorController.findSocialBy));
...
// Episodes
v1.get('/episodes', asyncHandler(episodeController.findAll));
v1.get('/episodes/random', asyncHandler(episodeController.findRandom));
v1.get('/episodes/:uuid', asyncHandler(episodeController.findBy));
v1.get('/episodes/:uuid/translations', asyncHandler(episodeController.findAllTranslationsBy));
v1.get('/episodes/:uuid/translations/random', asyncHandler(episodeController.findRandomTranslation));
v1.get('/episodes/:uuid/translations/:language', asyncHandler(episodeController.findTranslationBy));
...
// Games
v1.get('/games', asyncHandler(gameController.findAll));
v1.get('/games/random', asyncHandler(gameController.findRandom));
v1.get('/games/:uuid', asyncHandler(gameController.findBy));
v1.get('/games/:uuid/translations', asyncHandler(gameController.findAllTranslationsBy));
v1.get('/games/:uuid/translations/random', asyncHandler(gameController.findRandomTranslation));
v1.get('/games/:uuid/translations/:language', asyncHandler(gameController.findTranslationBy));
...
// Locations
v1.get('/locations', asyncHandler(locationController.findAll));
v1.get('/locations/random', asyncHandler(locationController.findRandom));
v1.get('/locations/:uuid', asyncHandler(locationController.findBy));
v1.get('/locations/:uuid/translations', asyncHandler(locationController.findAllTranslationsBy));
v1.get('/locations/:uuid/translations/random', asyncHandler(locationController.findRandomTranslation));
v1.get('/locations/:uuid/translations/:language', asyncHandler(locationController.findTranslationBy));
...
// Seasons
v1.get('/seasons', asyncHandler(seasonController.findAll));
v1.get('/seasons/random', asyncHandler(seasonController.findRandom));
v1.get('/seasons/:uuid', asyncHandler(seasonController.findBy));
v1.get('/seasons/:uuid/translations', asyncHandler(seasonController.findAllTranslationsBy));
v1.get('/seasons/:uuid/translations/random', asyncHandler(seasonController.findRandomTranslation));
v1.get('/seasons/:uuid/translations/:language', asyncHandler(seasonController.findTranslationBy));
...
// Translations
v1.get('/translations', asyncHandler(translationController.findAll));

// Soundtracks
v1.get('/soundtracks', asyncHandler(soundtrackController.findAll));
v1.get('/soundtracks/random', asyncHandler(soundtrackController.findRandom));
v1.get('/soundtracks/:uuid', asyncHandler(soundtrackController.findBy));
...
// Overview
v1.get('/overview', asyncHandler(overviewController.find));
v1.get('/overview/translations', asyncHandler(overviewController.findAllTranslations));
v1.get('/overview/translations/:language', asyncHandler(overviewController.findTranslationBy));
