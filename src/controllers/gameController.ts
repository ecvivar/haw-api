...
export class GameController {
  ...
  async findRandom(req: AuthRequest, res: Response): Promise<void> {
    ...
    const result = await gameService.findRandom(language);
    setContentLanguage(res, language);
    res.json(result);
  }

  async findAllTranslationsBy(req: AuthRequest, res: Response): Promise<void> {
    const result = await gameService.findAllTranslationsBy(req.params.uuid);
    res.json(result);
  }

  async findRandomTranslation(req: AuthRequest, res: Response): Promise<void> {
    const result = await gameService.findRandomTranslation(req.params.uuid);
  ...
  async findBy(req: AuthRequest, res: Response): Promise<void> {
    const language = (req.query.language as string) || getDefaultLanguage();
    const result = await gameService.findBy(req.params.uuid, language);
    setContentLanguage(res, language);
    res.json(result);
  }

  async findTranslationBy(req: AuthRequest, res: Response): Promise<void> {
    const result = await gameService.findTranslationBy(req.params.uuid, req.params.language);
    setContentLanguage(res, result.language || '');
    res.json(result);
  }

  async save(req: AuthRequest, res: Response): Promise<void> {
    const result = await gameService.save(req.body);
    res.status(201).json(result);
  }

  async saveTranslation(req: AuthRequest, res: Response): Promise<void> {
    const result = await gameService.saveTranslation(req.params.uuid, req.body);
    setContentLanguage(res, result.language || '');
    res.status(201).json(result);
  }

  async patch(req: AuthRequest, res: Response): Promise<void> {
    const result = await gameService.patch(req.params.uuid, req.body);
    res.json(result);
  }

  async patchTranslation(req: AuthRequest, res: Response): Promise<void> {
    const result = await gameService.patchTranslation(req.params.uuid, req.params.language, req.body);
    setContentLanguage(res, req.params.language);
    res.json(result);
  }

  async delete(req: AuthRequest, res: Response): Promise<void> {
    await gameService.deleteById(req.params.uuid);
    res.status(204).send();
  }

  async deleteTranslation(req: AuthRequest, res: Response): Promise<void> {
    await gameService.deleteTranslation(req.params.uuid, req.params.language);
    res.status(204).send();
  }
}
